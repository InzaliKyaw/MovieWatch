...
import com.example.movieswatch.persistance.daos.PopularMovieResultDao
...
object RetrofitDataAgentImpl : MoviesDataAgents {
    override fun getDiscoverMovie(withGenres: Int, accessToken: String) {
    ...
    override fun getDiscoverMovie(
        ...
        onFailure: (String) -> Unit
            ...
            val getDiscoverMovieCall = mMoviesApi?.getDiscoverMovies(withGenres,accessToken)
            getDiscoverMovieCall?.enqueue(object :Callback<GetPopularMoviesResponse> {
                override fun onFailure(call: Call<GetPopularMoviesResponse>, t: Throwable) {
                    onFailure(t.message ?: NO_INTERNET_CONNECTION)
